...
{	
	...
	public Program getProrgamById(JSONObject programJson) throws Exception
	{
		...
		try
		{
			...
			//set description
			oneProgram.setDescription(programJson.getString("description"));
			
			//set watch_count
			oneProgram.setSubscribeCount(programJson.getInt("watch_count"));
	...
	public JSONArray requestAllTvStations(int catalog) throws Exception 
	{
	
		String cmdLine = mCommandStr[0];
		cmdLine += catalog;
		cmdLine += ".json?cmd=detail";
